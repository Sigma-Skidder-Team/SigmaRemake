...
public class MainPage extends GuiComponent implements IMinecraft {
    ...
    public MainPage(GuiComponent var1, String var2, int var3, int var4, int var5, int var6) {
        ...
        int xOffset = 0;
        this.addToList(this.singleplayerButton = new AnimatedRoundButton(this, "Singleplayer", this.calculateButtonX(xOffset++), this.calculateButtonY(), 128, 128, Resources.SINGLEPLAYER_ICON, new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.getColor(), ClientColors.DEEP_TEAL.getColor())));
        this.addToList(this.multiplayerButton = new AnimatedRoundButton(this, "Multiplayer", this.calculateButtonX(xOffset++), this.calculateButtonY(), 128, 128, Resources.MULTIPLAYER_ICON, new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.getColor(), ClientColors.DEEP_TEAL.getColor())));
        this.addToList(this.realmsButton = new AnimatedRoundButton(this, "Realms", this.calculateButtonX(xOffset++), this.calculateButtonY(), 128, 128, Resources.WORLD_ICON, new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.getColor(), ClientColors.DEEP_TEAL.getColor())));
        this.addToList(this.optionsButton = new AnimatedRoundButton(this, "Options", this.calculateButtonX(xOffset++), this.calculateButtonY(), 128, 128, Resources.OPTIONS_ICON, new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.getColor(), ClientColors.DEEP_TEAL.getColor())));
        this.addToList(this.altManagerButton = new AnimatedRoundButton(this, "Alt Manager", this.calculateButtonX(xOffset), this.calculateButtonY(), 128, 128, Resources.ALT_ICON, new ColorHelper(ClientColors.LIGHT_GREYISH_BLUE.getColor(), ClientColors.DEEP_TEAL.getColor())));
