...
public class InteractiveWidget extends AnimatedIconPanel {
    ...
    public InteractiveWidget(CustomGuiScreen screen, String typeThingIdk, int x, int y, int width, int height, ColorHelper var7, boolean var8) {
        super(screen, typeThingIdk, x, y, width, height, var7, var8);
    }

    public InteractiveWidget(CustomGuiScreen screen, String typeThingIdk, int x, int y, int width, int height, ColorHelper var7, String text, boolean var9) {
        super(screen, typeThingIdk, x, y, width, height, var7, text, var9);
    }

    public InteractiveWidget(CustomGuiScreen screen, String typeThingIdk, int x, int y, int width, int height, ColorHelper var7, String var8, TrueTypeFont font, boolean var10) {
