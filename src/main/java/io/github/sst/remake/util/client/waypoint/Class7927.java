...
public class Class7927 {
    ...
    public HashMap<Integer, byte[]> field33959 = new HashMap<>();
    ...
    public Class7927(ObjectInputStream var1) {
        try {
            ...
            Client.LOGGER.warn("Failed to Class7927", e);
        }
    }

    public void method26599(ByteBuffer var1, ChunkPos var2) {
        byte[] var5 = new byte[var1.capacity()];
        var1.get(var5, 0, var5.length);
        this.field33959.put(this.method26601(var2), var5);
    }

    public ByteBuffer method26600(ChunkPos var1) {
