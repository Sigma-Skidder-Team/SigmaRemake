 ...
 * <p>
 * Fresh cut of code but largely influenced by the TGA loading class
 * provided as part of the Java Monkey Engine (JME). Why not check out
 * what they're doing over at <a href="https://jmonkeyengine.org/">https://jmonkeyengine.org/</a>. kudos to
 * Mark Powell.
 *
 * @author Kevin Glass
 */
