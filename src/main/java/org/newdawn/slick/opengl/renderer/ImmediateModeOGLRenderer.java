...
public class ImmediateModeOGLRenderer implements SGL {
   ...
   /**
    * @see org.newdawn.slick.opengl.renderer.SGL#glClipPlane(int, DoubleBuffer)
    */
   ...
   /**
    * @see org.newdawn.slick.opengl.renderer.SGL#glDeleteTextures(IntBuffer)
    */
   ...
   /**
    * @see org.newdawn.slick.opengl.renderer.SGL#glGetFloat(int, FloatBuffer)
    */
   ...
   /**
    * @see org.newdawn.slick.opengl.renderer.SGL#glGetInteger(int, IntBuffer)
    */
   ...
   /**
    * @see org.newdawn.slick.opengl.renderer.SGL#glGetTexImage(int, int, int, int, ByteBuffer)
    */
   ...
   /**
    * @see org.newdawn.slick.opengl.renderer.SGL#glReadPixels(int, int, int, int, int, int, ByteBuffer)
    */
   ...
   /**
    * @see org.newdawn.slick.opengl.renderer.SGL#glLoadMatrix(FloatBuffer)
    */
   ...
   /*
    * (non-Javadoc)
    * @see org.newdawn.org.newdawn.slick.slick.opengl.renderer.SGL#glGenTextures(java.nio.IntBuffer)
    */
   ...
   /*
    * (non-Javadoc)
    * @see org.newdawn.org.newdawn.slick.slick.opengl.renderer.SGL#glGetError()
    */
   ...
   /*
    * (non-Javadoc)
    * @see org.newdawn.org.newdawn.slick.slick.opengl.renderer.SGL#glTexImage2D(int, int, int, int, int, int, int, int, java.nio.ByteBuffer)
    */
