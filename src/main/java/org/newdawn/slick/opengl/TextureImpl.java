 ...
 * @author Brian Matzon
 */
public class TextureImpl implements Texture, ILogger {
    /**
    ...
    /**
     * Clear org.newdawn.slick.slick caching of the last bound texture so that an
     * external texture binder can play with the context before returning
     * control to org.newdawn.slick.slick.
     */
