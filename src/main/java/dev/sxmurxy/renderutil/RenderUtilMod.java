...
public class RenderUtilMod implements Wrapper {
    ...
    public void onRender() {
		...
		DrawHelper.drawRoundedTexture(new Identifier("textures/entity/steve.png"), 60, 280, 30, 30, 8, 8, 8, 8, 3);
		DrawHelper.drawRoundedTexture(new Identifier("textures/block/stone.png"), 110, 280, 30, 30, 5);
