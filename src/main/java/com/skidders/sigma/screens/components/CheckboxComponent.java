...
public class CheckboxComponent {
    ...
    public boolean draw(MouseHandler mouse, boolean value, double mouseX, double mouseY, float x, float y) {
        ...
        RenderUtil.circle(x + 6, y + 6, 5.5, value ? mouseDown && hover ? new Color(36, 149, 229) : new Color(41, 166, 255) : mouseDown && hover ? new Color(217, 217, 217) : new Color(227, 227, 227));
